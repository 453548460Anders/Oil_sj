...
;(function(win,Zepto){
    ...
    sS.prototype.init = function(options){
        ...
        // 横竖屏、窗口调整
        Zepto(win).on('onorientationchange' in win ? 'orientationchange' : 'resize',function(){
        ...
        function fnGetSlideDistance(){
            ...
            me._slideDistance = window.screen.width;
            // 定位
            ...
            $li.each(function(i){
                fnTranslate(me, Zepto(this), me._slideDistance*(i+num));
            });
        }
    };
